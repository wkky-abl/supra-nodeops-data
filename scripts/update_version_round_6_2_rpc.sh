...
if ! docker rmi  asia-docker.pkg.dev/supra-devnet-misc/supra-testnet/rpc-node:v6.3.2; then
...
if !     docker run --name "supra_rpc_$ip_address" \
        ...
        --net=host \
        -itd asia-docker.pkg.dev/supra-devnet-misc/supra-testnet/rpc-node:v6.3.9; then
